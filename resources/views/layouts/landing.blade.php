                ...
                <div class="intro-contain">
                    <div>
                        <h2 class="wow fadeInLeft"
                            data-wow-duration="1s">{{__('Smart Fleet - Vehicle Tracking System')}}</h2>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s">{{__('Smart Fleet system is provides functionalities for organizing, monitoring, and maintaining vehicles, including features such as vehicle registration, tracking, maintenance scheduling, driver management, and reporting..')}}</p>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    ...
                    <p class="wow fadeInRight">{{__('Smart Fleet system is provides functionalities for organizing, monitoring, and maintaining vehicles, including features such as vehicle registration, tracking, maintenance scheduling, driver management, and reporting..')}}</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="header-detail">
                    <div>
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s">500+ {{__('Booking')}}</h2>
                        <p class="wow fadeInUp"
                           data-wow-duration="1.3s">{{__('Smart Fleet system is provides functionalities for organizing, monitoring, and maintaining vehicles, including features such as vehicle registration, tracking, maintenance scheduling, driver management, and reporting..')}}</p>
                        <a
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white">{{__('Booking')}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white">{{__('Booking Details')}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white">{{__('Vehicles')}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white">{{__('Inspection Details')}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
