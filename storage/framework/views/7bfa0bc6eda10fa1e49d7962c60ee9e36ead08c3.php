                ...
                <div class="intro-contain">
                    <div>
                        <h2 class="wow fadeInLeft"
                            data-wow-duration="1s"><?php echo e(__('Smart Fleet - Vehicle Tracking System')); ?></h2>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s"><?php echo e(__('Smart Fleet system is provides functionalities for organizing, monitoring, and maintaining vehicles, including features such as vehicle registration, tracking, maintenance scheduling, driver management, and reporting..')); ?></p>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    ...
                    <p class="wow fadeInRight"><?php echo e(__('Smart Fleet system is provides functionalities for organizing, monitoring, and maintaining vehicles, including features such as vehicle registration, tracking, maintenance scheduling, driver management, and reporting..')); ?></p>
                </div>
            </div>
        </div>
        <div class="row cdx-row justify-content-center">
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('Subscription')); ?></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="header-detail">
                    <div>
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s">500+ <?php echo e(__('Booking')); ?></h2>
                        <p class="wow fadeInUp"
                           data-wow-duration="1.3s"><?php echo e(__('Smart Fleet system is provides functionalities for organizing, monitoring, and maintaining vehicles, including features such as vehicle registration, tracking, maintenance scheduling, driver management, and reporting..')); ?></p>
                        <a
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Booking')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Booking Details')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Vehicles')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Inspection Details')); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row cdx-row">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('Booking Details')); ?></h3>
                    </div>
                </div>
            </div>
...
<?php /**PATH /Users/johnny/Documents/Projectos/smart-fleet-saas v2/main_file/resources/views/layouts/landing.blade.php ENDPATH**/ ?>